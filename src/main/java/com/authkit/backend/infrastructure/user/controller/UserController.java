package com.authkit.backend.infrastructure.user.controller;
...
import com.authkit.backend.infrastructure.user.dto.*;
import com.authkit.backend.infrastructure.user.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<?> updateUserData(
        ...
        userService.updateUserData(userDetails.getUsername(), request.getNewName(), request.getNewUsername(), request.getNewSurname());
